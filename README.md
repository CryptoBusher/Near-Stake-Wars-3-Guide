...
Статья написана не для того, чтоб ознакомить вас с наградами, которые нам обещает команда проекта. Вы сами можете ознакомиться со всем необходимым на [оффициальной страничке Stake Wars III](https://near.org/stakewars/) или в социальных статьях проекта. Цель статьи - подробно описать процесс прохождения заданий с технической стороны.
...
![](_attachments/Pasted image 20220801183304.png)
![My animated logo](_attachments/Pasted image 20220801183304.png)
...
![[_attachments/Pasted image 20220801183512.png]]
...
![[_attachments/Pasted image 20220801183839.png]]
...
![[_attachments/Pasted image 20220801184301.png]]

Жмем кнопку "SSH".

![[_attachments/Pasted image 20220801193124.png]]

В поле "Remote host" вбиваем наш IPv4, ставим галочку в поле "Specify username" и вписываем туда "root", далее жмем "OK".

![[_attachments/Pasted image 20220801184439.png]]
...
![[_attachments/Pasted image 20220801184842.png]]

Сервак готов к работе.

![[_attachments/Pasted image 20220801184938.png]]
...
![[_attachments/Pasted image 20220801185632.png]]

Выбираем себе ник и жмем синюю кнопку.

![[_attachments/Pasted image 20220801185729.png]]

В качестве метода защиты я выбрал "Secure Passphrase".

![[_attachments/Pasted image 20220801185817.png]]
...
![[_attachments/Pasted image 20220801190557.png]]

```
curl -sL https://deb.nodesource.com/setup_18.x | sudo -E bash - 
```

![[_attachments/Pasted image 20220801190641.png]]

```
sudo apt install build-essential nodejs
```

![[_attachments/Pasted image 20220801190709.png]]

Вбиваем "Y" и жмем ENTER.

![[_attachments/Pasted image 20220801190758.png]]

```
PATH="$PATH"
```

![[_attachments/Pasted image 20220801190819.png]]
...
![[_attachments/Pasted image 20220801190917.png]]
...
![[_attachments/Pasted image 20220801190953.png]]

```
sudo npm install -g near-cli
```

![[_attachments/Pasted image 20220801191033.png]]

```
export NEAR_ENV=shardnet
```

![[_attachments/Pasted image 20220801191101.png]]

```
echo 'export NEAR_ENV=shardnet' >> ~/.bashrc
```

![[_attachments/Pasted image 20220801191120.png]]

```
echo 'export NEAR_ENV=shardnet' >> ~/.bash_profile
```

![[_attachments/Pasted image 20220801191137.png]]

```
source $HOME/.bash_profile
```

![[_attachments/Pasted image 20220801191154.png]]
...
![[_attachments/Pasted image 20220801191306.png]]
...
![[_attachments/Pasted image 20220801191518.png]]

```
sudo apt install -y git binutils-dev libcurl4-openssl-dev zlib1g-dev libdw-dev libiberty-dev cmake gcc g++ python docker.io protobuf-compiler libssl-dev pkg-config clang llvm cargo
```

![[_attachments/Pasted image 20220801191651.png]]

```
apt-get install containerd=1.3.3-0ubuntu2
```

![[_attachments/Pasted image 20220801191706.png]]

Вбиваем "Y" и жмем ENTER.

![[_attachments/Pasted image 20220801191749.png]]

```
sudo apt install python3-pip
```

![[_attachments/Pasted image 20220801191808.png]]

Вбиваем "Y" и жмем ENTER.

![[_attachments/Pasted image 20220801191825.png]]

```
USER_BASE_BIN=$(python3 -m site --user-base)/bin
```

![[_attachments/Pasted image 20220801191846.png]]

```
export PATH="$USER_BASE_BIN:$PATH"
```

![[_attachments/Pasted image 20220801191900.png]]

```
sudo apt install clang build-essential make
```

![[_attachments/Pasted image 20220801191920.png]]

```
curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh
```

![[_attachments/Pasted image 20220801191946.png]]

Вбиваем "y" и жмем ENTER.

![[_attachments/Pasted image 20220801191959.png]]

Вбиваем "1" и жмем ENTER.

![[_attachments/Pasted image 20220801192036.png]]

```
source $HOME/.cargo/env
```

![[_attachments/Pasted image 20220801192054.png]]

```
git clone https://github.com/near/nearcore
```

![[_attachments/Pasted image 20220801192426.png]]

```
cd nearcore
```

![[_attachments/Pasted image 20220801192437.png]]

```
git fetch
```

![[_attachments/Pasted image 20220801192459.png]]
...
![[_attachments/Pasted image 20220801192723.png]]

```
git checkout c1b047b8187accbf6bd16539feb7bb60185bdc38
```

![[_attachments/Pasted image 20220801192843.png]]
...
![[_attachments/Pasted image 20220801194224.png]]

```
./target/release/neard --home ~/.near init --chain-id shardnet --download-genesis
```

![[_attachments/Pasted image 20220801194402.png]]

```
rm ~/.near/config.json
```

![[_attachments/Pasted image 20220801194453.png]]

```
wget -O ~/.near/config.json https://s3-us-west-1.amazonaws.com/build.nearprotocol.com/nearcore-deploy/shardnet/config.json
```

![[_attachments/Pasted image 20220801194540.png]]
...
![[_attachments/Pasted image 20220801224848.png]]
...
![[_attachments/Pasted image 20220801232149.png]]

### Активируем валидатора

Нажимаем "CTRL+C" в консоли.

![[_attachments/Pasted image 20220801232328.png]]

```
near login
```

![[_attachments/Pasted image 20220801232419.png]]

Вбиваем "y" и жмем ENTER.

![[_attachments/Pasted image 20220801232510.png]]

Полностью копируем ссылку из терминала и вставляем ее в браузер, в котором мы залогинены в наш кошелек.

![[_attachments/Pasted image 20220801232603.png]]

Жмем "Next".

![[_attachments/Pasted image 20220801232634.png]]

Жмем "Connect".

![[_attachments/Pasted image 20220801232703.png]]

Вставляем адрес нашего кошелька в поле и жмем "Confirm". На этом этапе просто ждем, пока появится такая страница.

![[_attachments/Pasted image 20220801232803.png]]

Идем обратно в терминал и вбиваем адрес нашего кошелька, жмем ENTER. Должна появиться инфа о том, что кошелек подключен.

![[_attachments/Pasted image 20220801232919.png]]

	```
	cd ..
	```
	
	![[_attachments/Pasted image 20220801233031.png]]
...
![[_attachments/Pasted image 20220801233156.png]]
...
![[_attachments/Pasted image 20220801233546.png]]
...
![[_attachments/Pasted image 20220801233751.png]]
...
![[_attachments/Pasted image 20220801234759.png]]

Жмем "CTRL+C".

![[_attachments/Pasted image 20220801234834.png]]

```
sudo vi /etc/systemd/system/neard.service
```

![[_attachments/Pasted image 20220801234918.png]]

Открывается редактор, жмем клавишу "i".

![[_attachments/Pasted image 20220801234931.png]]
...
![[_attachments/Pasted image 20220801235523.png]]

Эмем "ESC".

![[_attachments/Pasted image 20220801235545.png]]

Жмем ":", вписываем "wq" и жмем "ENTER".

![[_attachments/Pasted image 20220801235631.png]]
![[_attachments/Pasted image 20220801235645.png]]

```
sudo systemctl enable neard
```

![[_attachments/Pasted image 20220801235715.png]]

```
sudo systemctl start neard
```

![[_attachments/Pasted image 20220801235735.png]]

```
sudo apt install ccze
```

![[_attachments/Pasted image 20220801235817.png]]
...
![[_attachments/Pasted image 20220802000036.png]]
...
![[_attachments/Pasted image 20220802001334.png]]
...
![[_attachments/Pasted image 20220802001456.png]]
...
![[_attachments/Pasted image 20220802003926.png]]
...
![[_attachments/Pasted image 20220802004500.png]]
...
![[_attachments/Pasted image 20220802004851.png]]
...
![[_attachments/Pasted image 20220802145024.png]]

Вбиваем "Y" и жмем ENTER.

![[_attachments/Pasted image 20220802145112.png]]
...
![[_attachments/Pasted image 20220802150225.png]]

```
cd ..
```

![[_attachments/Pasted image 20220802150330.png]]

```
pwd
```

![[_attachments/Pasted image 20220802150349.png]]
...
![[_attachments/Pasted image 20220802150541.png]]
...
![[_attachments/Pasted image 20220802150614.png]]
...
![[_attachments/Pasted image 20220802150709.png]]
...
![[_attachments/Pasted image 20220802150830.png]]

Жму "i".

![[_attachments/Pasted image 20220802150854.png]]
...
![[_attachments/Pasted image 20220802151235.png]]

Жму "ESC". 

![[_attachments/Pasted image 20220802151258.png]]

Жму ":" и пишу "wq".

![[_attachments/Pasted image 20220802151332.png]]

Жму "ENTER".

![[_attachments/Pasted image 20220802151354.png]]
...
![[_attachments/Pasted image 20220802151506.png]]
...
![[_attachments/Pasted image 20220802151540.png]]
...
![[_attachments/Pasted image 20220802151627.png]]

Я выбрал второй вариант, жму "2" и "ENTER".

![[_attachments/Pasted image 20220802151712.png]]
...
![[_attachments/Pasted image 20220802151805.png]]

Жму "ESC", жму ":", пишу "wq" и жму "ENTER".

![[_attachments/Pasted image 20220802151849.png]]
...
![[_attachments/Pasted image 20220802153007.png]]

```
rustup target add wasm32-unknown-unknown
```

![[_attachments/Pasted image 20220802152539.png]]
...
![[_attachments/Pasted image 20220802152652.png]]

```
cd github
```

![[_attachments/Pasted image 20220802152715.png]]

```
git clone https://github.com/zavodil/near-staking-pool-owner
```

![[_attachments/Pasted image 20220802153053.png]]

```
cd near-staking-pool-owner/contract
```

![[_attachments/Pasted image 20220802153119.png]]

```
cargo build --target wasm32-unknown-unknown --release
```

![[_attachments/Pasted image 20220802153231.png]]
...
![[_attachments/Pasted image 20220802153438.png]]
...
![[_attachments/Pasted image 20220802154046.png]]
...
![[_attachments/Pasted image 20220802155211.png]]
